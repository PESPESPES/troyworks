...
{
	public class IntRangeFilter extends RangeFilter
	{
		...
		public function IntRangeFilter(minVal:int, maxVal:int,
		...
		public function passesMinCheck(val : int, relationshipToA : String, processInvert : Boolean = true) : Boolean {
		...
		public function passesMaxCheck(val : int,  relationshipToB : String, processInvert : Boolean = true) : Boolean {
			var res : Boolean = false;
