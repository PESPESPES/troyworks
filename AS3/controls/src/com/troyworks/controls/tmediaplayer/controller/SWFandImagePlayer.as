				...
				case SIG_PULSE :
				{
					...
					} else
					{
						...
						if (autoPlay)
						{
							...
							setupForPlay ();
							tran (s15_altraneIn);
		tran/shell_mc.visible = true;
							
						} else
						{
							trace (this + " media: " + mediaPath + " *****awaiting key stroke*******");
							tran (s10_paustranginning);
tran}
					}
					return null;
				}
		...
		//	onFunctionEnter ("s10_pausedAtBeginning-", e, []);
			switch (e.sig)
			{
				...
				{
					shell_mc.ph_mc.play ();
					tran (s11_playintran			return nutran		}
		...
		//	onFunctionEnter ("s11_playing-", e, []);
			switch (e.sig)
			{
				...
				{
					shell_mc.ph_mc.stop ();
					tran (s13_pausedIntran);
					returntran
				}
				case TRANS_IN_EVT :
				{
					tran (s15_alphafadeItran			//	shell_mc.vtran = true;
					return null;
				}
				case TRANS_OUT_EVT :
				{
					tran (s14_alphafadeOuttran		//	shell_mc.visitranfalse;
					return null;
				}
				case SIG_PULSE :
				{
	...
	//						shell_mc.y = Math.round (_cy);
				...
				case GOTOANDSTOP_EVT :
				{
					...
					tran (s10_pausedAtBeginntran					return null;
		tran	}
			return s2_hasMediaPath ;
		}
		function s12_stopped (e : CogEvent) : Function
		{
			...
			switch (e.sig)
			{
				...
				{
					shell_mc.ph_mc.gotoAndStop (1);
					tran (s10_pausedAtBeginnintran			return null;
				}
transe PLAY_EVT :
				{
					shell_mc.ph_mc.play ();
				...
				{
					shell_mc.ph_mc.gotoAndStop (1);
					tran (s10_pausedAtBeginning);
traneturn null;
				}
			}
			tran s2_hasMediaPath ;
		}
		...
		tranurn null;
				...
				case PLAtran:
				{
					...
					tran (s11_playing);
					return nutran		}
				case GOTOANDSTOP_EVT :tran
					shell_mc.ph_mc.gotoAndStop (1);
					tran (s10_pausedAtBeginning);
					rtrannull;
				}
			}
			return s2_hatranPath ;
		}
