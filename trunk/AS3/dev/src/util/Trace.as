package util { 
	...
	* CODE:
	...
	public class Trace {
		...
		////////////////////////////////////////////////////////////////////////
		public static function me(objStruct : Object, txt : String, showNested : Boolean= false, showType : Boolean = false, showValue : Boolean = false) : String
		{
			depth = 0;
		...
		public static function meAsArray(objStruct : Object, txt : String, showNested : Boolean, showType : Boolean  = false, showValue : Boolean = false, depth:Number = 0) : Array{
			//this is used to prevent infinite loops
			var res = new Array ();
	//		if(objStruct.$$_id_ == null){
	//			objStruct.$$_id_ = IDz++;
	//TODO			global.ASSetPropFlags (objStruct, "$$_id_", 1);
	...
	//		}
		//	trace(objStruct._id_ +"  " + objStruct.$$_id_ +" AA \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\");
			if(history != null){
				...
				var t2 : Boolean = false;//not supported in AS3 (objStruct == undefined);
