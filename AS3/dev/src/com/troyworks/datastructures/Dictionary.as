package  { 
	class com.troyworks.datastructures.Dictionary extends Object
	{
		///////////////////////////////
		// Stores things as one type multiple values
		// e.g. Dictionary.word[0...N] definitions.
			protected static var _className : String = "com.troyworks.datastructures.Dictionary";
		...
		public function removeAllItems (key : String, value : String) : Object
		{
			if (key == null || key == " ")
			{
				key = "_";
		...
		public function toString(keysOnly:Boolean):String{
			...
			for(var i in this){
				var v = (keysOnly == null || keysOnly == false)?"' = v:'" + this[i]+"'":"";
				var s:String = " k:'" + i + v;
				res.push(s);
			}
			res.reverse(); 
