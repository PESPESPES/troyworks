package com.troyworks.ui.menus { 
	...
	public class Table3DRotaryCarouselMenu extends BaseComponent {
		...
		function released() : void {
			tran(s1_transitioningToForm);
		}
	
		function unReleased() : void {
			tran(s1_transitionFromFormToCarousel);
			selectedItem = null;
		}
	...
	//		trace("releaseToolTip");
		...
		/*.................................................................*/
		function s0_viewAssetsLoadeCogEventventventvent) : Function
		{
		...
		/*.................................................................*/
		function s1_animatingCCogEventgEventgEventgEvent) : Function
		{
			...
			/*.................................................................*/
		function s1_transiCogEventCogEventCogEventCogEvent) : Function
		{
				...
				case SIG_ENTRY :
				{
					...
					for (var i:Number = 0; i< users_Clips.length; i++) {
						...
						if (t != curSelectedClip) {
							...
							tw4.onMotionStopped = this.createCallback(SIG_PULSE, true);
			...
			/*.................................................................*/
	CogEventioCogEventnFCogEvent: CogEvent) : Function
		{
		...
		/*.................................................................*/
		function s1_traCogEventnFroCogEventoCarCogEvente : CogEvent) : Function
		{
			...
			switch (e.sig)
			{
				case SIG_ENTRY :
				{
					...
					if (t != curSelectedClip) {
							...
							tw4.onMotionStopped = createCallback(SIG_PULSE, true);
