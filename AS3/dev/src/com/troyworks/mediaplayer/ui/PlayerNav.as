package com.troyworks.mediaplayer.ui { 
	...
	public class PlayerNav extends BaseComponent {
		...
		public function onPlayerStateChanged(_ary : Array2) : void {
		//	REQUIRE(_ary != null && _ary is Array2, " PlayerNav.onPlayerStateChanged invalid arguments");
			var _ary2 : Array2 = _ary;// Array2(_ary[0]);
	//		_ary2.appendArray(_ary[1]);
		...
		public function s1_viewCreated(e : AEvent) : Function
		{
			...
			switch (e)
			{
				case ENTRY_EVT :
				{
					onPlayerStateChanged(new Array2());
					return null;
				}
				case EXIT_EVT :
				{
