...
package com.troyworks.core.tweeny {
	...
	public class TnyP extends Sprite{
		...
		public function TnyP(targetD:DisplayObject = null) {
		...
		*/
		...
		/*	if(isNaN(dur)){
			...
			//	trace("duration " + dur + " at  " + fps + " fps");
				...
				t = -dl/d; // if we have a delay, setup the delay as a percentage of the time (as we increment in percent)
				if(!lockStep){
					t += ts * Math.random();
				}
			}
