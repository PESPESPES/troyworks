package com.troyworks.framework.ui { 
	...
	*/
	...
	public class BaseComponent2 extends com.troyworks.hsmf.Hsmf  {
	...
	// capture positions
		...
		public function BaseComponent2(initialState : Function, hsmfName : String, aInit : Boolean)
		{
			super ((initialState != null)?initialState: s_initial, (hsmfName != null)?hsmfName:name+":BaseComponent2");
