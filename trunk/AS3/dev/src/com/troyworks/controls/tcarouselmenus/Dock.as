package com.troyworks.controls.tcarouselmenus { 
	...
	import com.troyworks.particleengine.ParticleEngine;
	/*
	...
	*/
	...
	//	callback: this.dockActions;
		...
		protected function createIcons() : void {
			...
			public var left : Number = (this.icon_min - this.width) / 2;
		...
		protected function createTray() : void {
			public var height : Number = this.icon_min + 2 * this.icon_spacing;
			public var width : Number = this.width + 2 * this.icon_spacing;
			public var mc : MovieClip = this.createEmptyMovieClip('tray_mc', 1);
