...
package com.troyworks.core.tweeny {
	...
	public class TweenyB extends Fsm {
		...
		private var _f:Function = None.easeOutIn;
	...
	public function notClose(number1:Number, number2:Number):Boolean
	{
		...
		public function setEasingFunctionToElastic(fn:Function, amplitude:Number = Number.NaN, period:Number = Number.NaN):void{
			ease = fn;
			_fA = [amplitude,period];
		}
		/* @param s		Overshoot ammount: higher s means greater overshoot (0 produces cubic easing with no overshoot, and the default value of 1.70158 produces an overshoot of 10 percent).*/
		public function setEasingFunctionToBack(fn:Function, overshoot:Number = Number.NaN):void{
			ease = fn;
			_fA = [overshoot];
		}
