package com.troyworks.mediaplayer { 
	...
	import com.troyworks.mediaplayer.model.PlayHead;
	import com.troyworks.mediaplayer.ui.PlayerNav;
	import com.troyworks.mediaplayer.ui.SeekBarNav;
	...
	public class MixinPlayer extends com.troyworks.mediaplayer.AMediaPlayer {
	...
	//						MixinPlayer.createMovieTracker(actual_mc);
		...
		public function s0_viewAssetsLoaded(e : AEvent) : Function
		{
			...
			switch (e)
			{
				...
				//	var opts:Array2 = stackOpts.concat(actual_mc.stackOpts.concat());
				//	__cStateOpts = opts;
					__cStateOpts=new Array2("ID:"+actual_mc._url,"REPLAY_CLIP");
					//playerControls_mc.onPlayerStateChanged(Array2(__cStateOpts));
					return null;
				}
		...
		public function s1_stopped(e : AEvent) : Function
		{
			...
			switch (e)
			{
				...
				case GETOPTS_EVT:{
					...
					var opts:Array2 =new Array2("ID:"+actual_mc._url,"PLAY_CLIP", "REWIND_AND_STOP", "FASTFORWARD_PLAY", "SEEK_TO", "FULLSCREEN_CLIP"); 
					__cStateOpts= opts;
		...
		public function s1_playing(e : AEvent) : Function
		{
			...
			switch (e)
			{
				...
				case GETOPTS_EVT:{
					...
					__cStateOpts= new Array2("ID:"+actual_mc._url,"PAUSE_CLIP", "REWIND_AND_STOP", "RESTART", "REWIND_PLAY", "FASTFORWARD_PLAY","SEEK_TO", "FULLSCREEN_CLIP");
					onPlaybackStateChanged();
					return null;
		...
		public function s2_stoppedAtBeginning(e : AEvent) : Function
		{
			...
			switch (e)
			{
				...
				case GETOPTS_EVT:{
					trace("s1_stopped GETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVT");
					var opts:Array2 =new Array2("ID:"+actual_mc._url,"PLAY_CLIP","FASTFORWARD_PLAY", "SEEK_TO", "FULLSCREEN_CLIP"); 
					__cStateOpts= opts;
					onPlaybackStateChanged();
					return null;
				}
		...
		public function s2_stoppedAtEnd(e : AEvent) : Function
		{
			...
			switch (e)
			{
				...
				case GETOPTS_EVT:{
					trace("s1_stopped GETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVTGETOPTS_EVT");
					var opts:Array2 =new Array2("ID:"+actual_mc._url,"REWIND_AND_STOP", "SEEK_TO", "FULLSCREEN_CLIP"); 
					__cStateOpts= opts;
					onPlaybackStateChanged();
					return null;
				}
