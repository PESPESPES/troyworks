package com.troyworks.data.tags { 
	...
	/**
	 * This is a utility to index string based tags (e.g. color, fruit, apple, red)
	 * and flatten them into a bitmask to uberfast speed comparisons, allowing retrieval and 
	 * avoiding duplicates, and also counting the times that term is in the index
	 * 
	 * Only good for 32 tags
	 * 
	 * 
