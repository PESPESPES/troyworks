...
package com.troyworks.framework.ui {
	...
	public class KeyboardCogEvent extends CogEvent{
		public static const KEY_DOWN:int = 0;
		public static const KEY_UP:int = 1;
		public var keyState:int = KEY_DOWN;
		public function KeyboardCogEvent(type:String, signal:CogSignal, bubbles:Boolean=false, cancelable:Boolean=false) {
