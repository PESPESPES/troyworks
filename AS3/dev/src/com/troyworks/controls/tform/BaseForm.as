package com.troyworks.controls.tform { 
	...
	public class BaseForm extends BaseComponent {
		...
		public function BaseForm(initialState : Function, hsmfName : String, aInit : Boolean) {
		...
		public function disableTabOnLabels():void{
			for(public var i:String in this){
				
				public var mc:Object = Object(this[i]);
