package  { 
	...
	import flash.net.URLRequest;
	{
		...
		var request:URLRequest = new URLRequest(ath : String = null;
				...
				public static function hasStartedLoading (clipPath : String):Boolean
				{
					var _mc = eval (clipPath);
				...
				public static function getURLCleaned () : String
				{
					if (SWFUtil.getURLPath == null)
					{
						var flashURL:String = unescape (_root._url);
						...
						//	trace (" ON A PC !!!!!!!!!!!!");
							...
							cleanedPath = SWFUtil.formatPath (cleanedPath);
				...
				public static function getOSName () : String
				{
					...
					var hasWin : Boolean = System.capabilities.os.toLowerCase ().indexOf ("win") != - 1;
					var hasMac : Boolean = System.capabilities.os.toLowerCase ().indexOf ("mac") != - 1;
					if (hasMac)
					{
						os = "mac";
						//find first number
		...
		var request:URLRequest = new URLRequest(leaned () : String
				{
					if (SWFUtil.getURLPath == null)
					{
						var flashURL:String = unescape (_root._url);
		...
		{
			var request:URLRequest = new URLRequest(ath == null)
						{
							var flashURL:String = unescape (_root._url);
							//"file:///C|/Documents%20and%20Settings/Troy%20Gardner/My%20Documents/Work%20My%20Current%20Projects/Schematic%20%2DMcDougal%20Littel/dev/flash/clientApplication/";
							var a:Number = flashURL.lastIndexOf ("/");
			...
			
			{
				...
				//trace ("cleanedPath " + cleanedPath);
				var request:URLRequest = new URLRequest(ath = cleanedPath;
							}
							return SWFUtil.getURLPath;
						}
						public static function formatPath (path : String, osN : String) : String
			...
			var request:URLRequest = new URLRequest(ath;
					}
					public static function formatPath (path : String, osN : String) : String
					{
						var sLocal : String = path;
