package com.troyworks.mediaplayer.controller { 
	...
	public class StreamPlayerBackup extends com.troyworks.mediaplayer.ASynchronizedMediaPlayer
	{
		...
		*/
		...
		function s0_awaitingUILoad (e : AEvent) : Function
		{
			...
			switch (e)
			{
				...
				case EXIT_EVT :
				{
					...
					//this.startPreloadAtClockTime = this.trk.A.position - (this.calcRemainingDownloadTime (this.bandwidth) *.75);
					this.connectToServer ();
				}
				return null;
			}
		...
		function s11a_startingPlaying (e : AEvent) : Function
		{
		...
		function s10_pausedAtBeginning (e : AEvent) : Function
		{
			...
			switch (e)
			{
				...
				case PLAY_EVT :
				this.nsResumePlay ();
				this.Q_TRAN (this.s11a_startingPlaying);
				return null;
				case NS_PAUSE_NOTIFY_EVT :
				case NS_PLAY_START_EVT :
				//	this.stream_mc.gotoAndStop ("green");
		...
		function s13_buffering (e : AEvent) : Function
		{
			...
			switch (e)
			{
				...
				{
					//the stream is stalling restart it.
