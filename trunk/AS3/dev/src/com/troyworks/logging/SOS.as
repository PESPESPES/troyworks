	...
	public class SOS extends Object{
		...
		public function connect():Boolean{
			...
			if(SOS._csock == null){
				...
				trace("SOS"+id+"BBBBBBBBBBBBBBBBBBBB COMMAND SOCKET CONNECTED BBBBBBBBBBBBBBBBBBBBBBBBB");
				isConnected = true;
			}
			if(SOS._msock == null){
				...
				trace("SOS"+id+"BBBBBBBBBBBBBBBBBBBB MESSAGE SOCKET CONNECTED BBBBBBBBBBBBBBBBBBBBBBBBB");				
				isConnected = true;
			}
		...
		public function showMessage(key : String ="com.troyworks.sos", sMessage : Object = "") : void{
			if(!isConnected){
				return;
			}
			if((sMessage is String) &&( String(sMessage).indexOf("\r") > -1)){
			//	trace("folded");
				...
				//	trace("normal");
					...
					_csock.send("<showMessage key='"+key + "'>"+sMessage.toString()+"</showMessage>\n");
				}
		}
		//////////////////////////// COMMANDS /////////////////////////////////////
