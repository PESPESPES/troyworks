package com.troyworks.mediaplayer.ui { 
	...
	public class MultiMediaWindow extends BaseComponent {
		...
		public static function createLoadingShell(_mc : MovieClip) : MovieClip{
			...
			public var shell_mc : MovieClip = _mc.createEmptyMovieClip("shell_mc", 2);//_mc.getNextHighestDepth());
			...
			public var background_mc : MovieClip = shell_mc.createEmptyMovieClip("background_mc", 2);
			public var ph_mc : MovieClip = shell_mc.createEmptyMovieClip("ph_mc", 3);
		...
		public static function setClipContentTo(base_mc : Object, target_mc : MovieClip, o : Object, alpha : Number, loadingProgress_mc : MovieClip) : MCLoader{
			...
			public var bounds : Object = new Object();
	...
	//		base_mc.shell_mc.ph_mc.height =height;// base_mc._oheight;
			...
			public var evtd:EVTD = new EVTD(EVTD_RECIEVED_CONTENT, this);
			dispatchEvent(evtd);
		}
		public function getContentBounds(context:MovieClip):Bounds2{
			...
			public var b2:Bounds2 = new Bounds2(base_mc.shell_mc.ph_mc.getBounds(context));
			return b2;
		}
		...
		//	trace("XXXXXXXXXXX Mixin SetContentWidth and Height" + w + " " + h + " curr " + this.width + " " + this.height + " " + util.Trace.me(this.base_mc));
			...
			public var xadj : Number = w/base_mc._owidth;
			public var yadj : Number = h/base_mc._oheight;
		...
		//	 trace("---------------- Movie Perspective----------");
			public var desiredWidth : Number = base_mc._oawidth *xadj ;
			public var desiredHeight : Number = base_mc._oaheight*yadj;
	...
	traceS();
		...
		public function onSetContent() : void{
			...
			trace("#######################################################");
			public var a : Alpha = new Alpha(base_mc.shell_mc.cover_mc);
