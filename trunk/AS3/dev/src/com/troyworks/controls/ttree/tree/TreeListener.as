package com.troyworks.ui.tree { 
	...
	import com.troyworks.ui.controls.DndTree;
	/**
	 * @author Troy Gardner
	 */
	...
	public class TreeListener extends BaseObject {
		...
		public var openNodes = new Object();
	
		protected var myTree1 : DndTree;
		...
		public static var EVTD_SINGLE_CLICK : String = "EVTD_SINGLE_CLICK";
		public static var EVTD_DOUBLE_CLICK : String = "EVTD_DOUBLE_CLICK";
		 ...
		 *  Constructor
		 */
		public function TreeListener(aMyTree : DndTree, aStatusLog : TextArea) {
			super();
			...
			myTree1.addEventListener("nodeOpen", this);
			myTree1.addEventListener("nodeClose", this);
			myTree1.addEventListener("change", this);
			myTree1.addEventListener("move", this);
			init();
		}
		public function setDataProvider(aTreeDP : ITreeDataProvider) : void{
			...
			treeDP.addEventListener("EVTD_MODEL_CHANGED", this, this.onModelChanged);
		...
		public function change(evt : Object) : void {
			...
			if (evt.target.selectedNode == this.activeNode) {
				...
				if (dur<200) {
					...
					this.dispatchEvent (
					{
						type : EVTD_DOUBLE_CLICK, target : this, activeNode:activeNode, activeObject:activeObject
					});
				}else{
				...
				this.dispatchEvent (
					{
						type : EVTD_SINGLE_CLICK, target : this, activeNode:activeNode, activeObject:activeObject
					});
