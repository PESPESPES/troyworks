	...
	*/
	...
	//			public var eventListenerExists:Function;
	  ...
	  // Time Values.. useful for more than just finding the date.
		...
		*/
		...
		public function TDate(year : Number, month : Number, date : Number, hour : Number, min : Number, sec : Number, ms : Number) {
	...
	//////////////////////////// MODIFIERS ////////////////////////////////////////////////
		public function decrementYear(num : Number) : Number{
			public var by : Number = (num== null)?1 :num ;
			return setYear(getFullYear()-by);
		}
		...
		public function setFullYear(value : Number) : Number{
			...
			public var res : Number = super.setFullYear.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setMonth(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setMonth.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setDate(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setDate.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setHours(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setHours.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setMinutes(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setMinutes.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setSeconds(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setSeconds.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setMilliseconds(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setMilliseconds.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		...
		public function setUTCFullYear(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setUTCFullYear.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setUTCMonth(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setUTCMonth.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setUTCDate(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setUTCDate.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setUTCHours(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setUTCHours.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setUTCMinutes(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setUTCMinutes.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setUTCSeconds(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setUTCSeconds.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setUTCMilliseconds(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setUTCMilliseconds.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function setYear(value : Number) : Number{
			startChangeTransaction();
			public var res : Number = super.setYear.apply(this, arguments);
			endChangeTransaction();
			return res;
		}
		public function isToday() : Boolean{
			public var tmpDate:Date = new Date();
			if(tmpDate.getDate() == getDate()){
				return true;
			}
			return false;
		}
		...
		public function isAWeekday() : Boolean{
			public var dN : Number = super.getDay();
			if(  0< dN || dN < 6 )	{
				return true;
			}
			return false;
		...
		function setDaysInMonth() : void {
			public var tempDate : Date = new Date(this.getYear(), this.getMonth()+1, 0);
		...
		function get daysInYear():Number {
			public var daysInYear : Number = 0;
			public var tempDate : Date = cloneAsDate();
			for (public var i : Number = 0; i < 12; i++) {
				tempDate.setMonth(i);
		...
		function monthEndDate() : Number {
			var tmpDate : Date = cloneAsDate();
			tmpDate.setDate(this.daysInMonth);
			var day : Number = tmpDate.getDay();
			return day;
		}
		...
		function setWeeksInMonth() : void	{
			...
			for (var i : Number = 0; i < daysInMonth + 1; i++) {
				tD.setDate(i);
		...
		public function clone() : TDate{
			...
			var f : Function = TDate;
			var res : TDate = new f(this);
			return res;
		}
		public function cloneAsDate() : Date{
			//needed to get around type checking in FDT/Mtasc
			var f : Function = Date;
			var res : Date = new f(this);
			return res;
		}
	}
