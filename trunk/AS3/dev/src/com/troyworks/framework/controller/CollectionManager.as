package com.troyworks.framework.controller { 
	...
	public class CollectionManager extends Fsm implements IArray, IExternalizable {
		...
		public static var EVTD_CONTENTS_CHANGED_ORD : String = "EVTD_CONTENTS_CHANGED_ORDER";
		public static var EVTD_CONTENTS_ACCESSED : String = "EVTD_CONTENTS_ACCESSED";
		public static var EVTD_ELEMENT_REMOVED : String = "EVTD_ELEMENT_REMOVED";
		public static var EVTD_ELEMENT_CHANGED : String = "EVTD_ELEMENT_CHANGED";
		public static var EVTD_CONTENTS_CHANGED_POSITION : String = "EVTD_CONTENTS_CHANGED_POSITION";
		...
		protected function dispatchContentChangedOrder() : void {
			dispatchEvent(new  Event(EVTD_CONTENTS_CHANGED_ORD));
			//	type :Event_COLLECTION_SIZE_CHANGED , target : this, oldVal : pEventousLength, newVaEvent.length
		...
		protected function dispatchSizeChanged() : void {
			...
			//tracEventispacthSizeChaEvent");
			dispatchEvent(new  Event(EVTD_COLLECTION_SIZE_CHANGED));
			//	type :Event_COLLECTION_SIZE_CHANGED , target : this, oldVal : pEventousLength, newVaEvent.length
			dispatchEvent(new  Event(EVTD_MODEL_CHANGED));
		}

		protected function dispatchContentsAccessedEvent() : void {
		...
		public function insertAt(idx : Number, values : Object) : ArrayX {
			startSizeChangeTransaction();
			var r : ArrayX = c.insertAt.apply(c, arguments);
			//(idx, values);
			endSizeChangeTransaction();
			dispatchSizeChanged();
			return r;	
		...
		public function removeFromCollectionAt(pos : Number, positions : Number) : ArrayX {
			startSizeChangeTransaction();
			var r : ArrayX = c.removeFromCollectionAt.apply(c, arguments);
			//(pos,positions);
			endSizeChangeTransaction();
			dispatchSizeChanged();
			return r;
		...
		public function removeFromCollectionItem(aValue_obj : Object) : Number {
			startSizeChangeTransaction();
			var r : Number = c.removeFromCollectionAt.apply(c, arguments);
			//aValue_obj);
			endSizeChangeTransaction();
			dispatchSizeChanged();
			return r;
		...
		public function push(value : Object) : Number {
			...
			startSizeChangeTransaction();
			trace("bbb");
			var r : Number = c.push.apply(c, arguments);
			//(value);
		...
		public function splice(startIndex : Number, deleteCount : Number, value : Object) : ArrayX {
			startSizeChangeTransaction();
			var r : ArrayX = c.splice.apply(c, arguments);
		...
		public function swapPlaces(objA : Object, objB : Object) : ArrayX {
			...
			var r : ArrayX = c.swapPlaces.apply(c, arguments);
			//objA, objB);
		...
		public function reorderPlaces(object : Array, desiredPlaces : Array) : ArrayX {
			startReorderElementsTransaction();
			var r : ArrayX = c.reorderPlaces.apply(c, arguments);
			//(object, desiredPlaces);
			endReorderElementsTransaction();
			dispatchContentChangedOrder();
			return r;
		}
		...
		public function shiftFromTo(idxFrom : Number, idxTo : Number) : ArrayX {
			startReorderElementsTransaction();
			var r : ArrayX = c.shiftFromTo.apply(c, arguments);
			//(idxFrom, idxTo);
			endReorderElementsTransaction();
			dispatchContentChangedOrder();
			return r;
		...
		public function shiftTowardsStart(idxFrom : Number, positions : Number) : ArrayX {
			startReorderElementsTransaction();
			var r : ArrayX = c.shiftTowardsStart.apply(c, arguments);
			//(idxFrom, positions);
			endReorderElementsTransaction();
			dispatchContentChangedOrder();
			return r;
		...
		public function shiftTowardsEnd(idxFrom : Number, positions : Number) : ArrayX {
			startReorderElementsTransaction();
			var r : ArrayX = c.shiftTowardsEnd.apply(c, arguments);
			//(idxFrom, positions);
			endReorderElementsTransaction();
			dispatchContentChangedOrder();
			return r;
		...
		public function shuffle(len : Number) : ArrayX {
			startReorderElementsTransaction();
			var r : ArrayX = c.shuffle.apply(c, arguments);
			//(len);
			endReorderElementsTransaction();
			dispatchContentChangedOrder();
			return r;
		...
		public function sort(compareFunction : Object, options : Number) : ArrayX {
			startReorderElementsTransaction();
			var r : ArrayX = c.sort.apply(c, arguments);
		...
		public function sortOn(fieldName : Object, options : Object) : ArrayX {
			startReorderElementsTransaction();
			var r : ArrayX = c.sortOn.apply(c, arguments);
			//(fieldName,options);
			endReorderElementsTransaction();
			dispatchContentChangedOrder();
			return r;
		...
		public function getFilteredSet(from : Number, to : Number, aThatsNot : Array, aThatsIsOneOf : Array) : ArrayX {
			var r : ArrayX = c.getFilteredSet.apply(c, arguments);
		...
		public function getFilteredRandomElement(from : Number, to : Number, aThatsNot : Array, aThatsIsOneOf : Array) : Object {
			var r : Object = c.getFilteredRandomElement.apply(c, arguments);
			//(from, to, aThatsNot, aThatsIsOneOf);
			return r;
		}
		...
		public function concat(value : Object) : ArrayX {
			...
			var r : ArrayX = c.concat.apply(c, arguments);
			//(value);
			return r;
		}
		...
		public function slice(startIndex : Number, endIndex : Number) : ArrayX {
			var r : ArrayX = c.sliceX.apply(c, arguments);
			//(startIndex,endIndex);
			return r;
		}
