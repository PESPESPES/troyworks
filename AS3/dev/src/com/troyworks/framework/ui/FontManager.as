package com.troyworks.framework.ui {
	...
	public class FontManager {
		...
		public function styleMe(clip : Sprite, label_txt : TextField) : void {
		...
		public function registerFont(fontLnkStr : String,  font_mc : MovieClip) : void {
			...
			trace("FontManager.registerFont " + fontLnkStr + " " + Trace.me(font_mc, "fonts_mc", true));
		...
		public static function testRuntimeFontUse(fontLinkageID : String,  _mc : MovieClip) : void {
			...
			_mc.testNormal_txt = new TextField();
			_mc.addChildAt(_mc.testNormal_txt, _mc.getNextHighestDepth());
			_mc.testNormal_txt.x = 110;
			_mc.testNormal_txt.y = 20 * ++count;
			_mc.testNormal_txt.width = 600;
			_mc.testNormal_txt.height = 20;
			//			_ary.push;

			_mc.testBold_txt = new TextField();
						_mc.addChildAt(_mc.testBold_txt, _mc.getNextHighestDepth());
						_mc.testBold_txt.x = 110;
						_mc.testBold_txt.y = 20 * ++count;
						_mc.testBold_txt.width = 600;
						_mc.testBold_txt.height = 20;
						_mc.testItalic_txt = new TextField();
						_mc.addChildAt(_mc.testItalic_txt, _mc.getNextHighestDepth());
						_mc.testItalic_txt.x = 110;
						_mc.testItalic_txt.y = 20 * ++count;
						_mc.testItalicBold_txt = new TextField();
						_mc.addChildAt(_mc.testItalicBold_txt, _mc.getNextHighestDepth());
						_mc.testItalicBold_txt.x = 110;
						_mc.testItalicBold_txt.y = 20 * ++count;
						_mc.testItalicBold_txt.width = 600;
						_mc.testItalicBold_txt.height = 20;
			...
			if(true) {
				_mc.testNormal_txt.html = true;
				_mc.testNormal_txt.type = "input";
				_mc.testNormal_txt.htmlText = "<font color='#FF0000'><b>" + fontLinkageID + style + "</b></font> !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~�������������������";
			}else {
				_mc.testNormal_txt.text = fontLinkageID + style + "!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~�������������������";
			}
			////////////////////////////////////////
			...
			_mc.testNormal_txt.autoSize = true;
			_mc.testNormal_txt.setTextFormat(format1_fmt);
			_mc.testNormal_txt.embedFonts = true;
		}
	}
}
