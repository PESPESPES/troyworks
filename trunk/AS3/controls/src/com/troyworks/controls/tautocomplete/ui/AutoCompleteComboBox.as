package com.troyworks.controls.tautocomplete.ui { 
	 ...
	 */
	import com.troyworks.controls.tautocomplete.WordMatch;	
...
/*	public function createChildren () : void {
		...
		input_txt.width = this.width;
		input_txt.height = this.height;
		addChild(input_txt);
		...
		shadow_txt = new TextField();
		addChildAt(shadow_txt, 0);
		shadow_txt.width = this.width;
		shadow_txt.height = this.height;
